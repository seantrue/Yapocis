...
__const float pi1o3 = (pi/3.0);
__const float pi2o3 = (2.0*pi/3.0);
__const float pi4o3 = (4.0*pi/3.0);
__const float pi5o3 = (5.0*pi/3.0);
...
__inline float ratio(float H, float angle1, float angle2) {
	return cos(H-angle1)/cos(angle2-H);
}
